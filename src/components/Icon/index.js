export function SearchIcon({ width = '24px', height = '24px' }) {
    return (
        <svg aria-hidden="true" className='pre-nav-design-ico' focusable="false" viewBox="0 0 24 24" role="img" width={width} height={height} fill="none">
...
export function HeartIcon({ width = '24px', height = '24px' }) {
    return (
...
export function UserIcon({ width = '24px', height = '24px', color }) {
    return (
